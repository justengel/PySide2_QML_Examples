...
//![1]
    ...
    Timer {
        ...
        repeat: true
        onTriggered: {
            dataSource.update(chartView.series(0), chartView.series(1));
        }
    }
    //![2]
    ...
    function changeSeconds(seconds) {
        dataSource.seconds = Number(seconds);
        axisX.max = dataSource.seconds;
    }
}
